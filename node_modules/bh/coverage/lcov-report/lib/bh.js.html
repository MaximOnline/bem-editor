...
<html lang="en">
<head>
    <title>Code coverage report for lib/bh.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/bh.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.19% <small>(379 / 386)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">92.2% <small>(319 / 346)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(42 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.16% <small>(373 / 380)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; bh.js</div>
</div>
<div class="body">
...
1056
1057
1058</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">7</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1317</span>
<span class="cline-any cline-yes">1317</span>
...
<span class="cline-any cline-yes">3</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1268</span>
...
<span class="cline-any cline-yes">1102</span>
<span class="cline-any cline-yes">1102</span>
<span class="cline-any cline-yes">1102</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1295</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1295</span>
<span class="cline-any cline-yes">1295</span>
<span class="cline-any cline-yes">1295</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1314</span>
<span class="cline-any cline-yes">1142</span>
<span class="cline-any cline-yes">8</span>
<span class="cline-any cline-yes">8</span>
<span class="cline-any cline-yes">14</span>
<span class="cline-any cline-yes">14</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var BH = (function() {
&nbsp;
var lastGenId = 0;
&nbsp;
/**
...
&nbsp;
        ...
        mod: function(key, value, force) {
            ...
            if (arguments.length &gt; 1) {
                ...
                mods = this.ctx.mods;
                return mods ? mods[key] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
            }
        },
        /**
        ...
        attr: function(key, value, force) {
            ...
            if (arguments.length &gt; 1) {
                ...
                return attrs ? attrs[key] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
            }
        },
        /**
        ...
        js: function(js, force) {
            if (js !== undefined) {
                this.ctx.js = force ?
                    (js === true ? <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>: js) :
...
&nbsp;
                    if (infiniteLoopDetection) {
                        ...
                        if (json.__processCounter &gt; 100) {
                            throw new Error('Infinite json loop detected at "' + json.block + (json.elem ? <span class="branch-0 cbranch-no" title="branch not covered" >'__' + json.elem </span>: '') + '".');
                        }
                        if (compiledMatcher.__processCounter &gt; 1000) {
                            throw new Error('Infinite matcher loop detected at "' + json.block + (json.elem ? <span class="branch-0 cbranch-no" title="branch not covered" >'__' + json.elem </span>: '') + '".');
                        }
                    }
&nbsp;
                    subRes = null;
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (!json._stop) {
                        ctx.node = node;
                        ctx.ctx = json;
...
&nbsp;
                ...
                if (!stopProcess) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(json)) {
<span class="cstat-no" title="statement not covered" >                        node.json = json;</span>
<span class="cstat-no" title="statement not covered" >                        node.blockName = block;</span>
<span class="cstat-no" title="statement not covered" >                        node.blockMods = blockMods;</span>
...
&nbsp;
            ...
            if (mixes &amp;&amp; mixes.length) {
                for (i = 0, l = mixes.length; i &lt; l; i++) {
                    var mix = mixes[i];
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (mix &amp;&amp; mix.js) {
<span class="cstat-no" title="statement not covered" >                        (jsParams = jsParams || {})[(mix.block || json.block) + (mix.elem ? '__' + mix.elem : '')] = mix.js === true ? {} : mix.js;</span>
<span class="cstat-no" title="statement not covered" >                        hasMixJsParams = true;</span>
                    }
                }
            }
&nbsp;
            if (jsParams) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (json.bem !== false) {
                    cls = cls + ' i-bem';
                }
                var jsData = (!hasMixJsParams &amp;&amp; json.js === true ?
                    '{&amp;quot;' + json.block + (json.elem ? <span class="branch-0 cbranch-no" title="branch not covered" >'__' + json.elem </span>: '') + '&amp;quot;:{}}' :
...
&nbsp;
            if (json.cls) {
                cls = cls ? cls + ' ' + json.cls : <span class="branch-1 cbranch-no" title="branch not covered" >json.cls;</span>
            }
&nbsp;
...
&nbsp;
    ...
    _init: function() {
        ...
        */
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof BEM !== 'undefined' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof BEM.I18N !== 'undefined')</span> {
<span class="cstat-no" title="statement not covered" >            this.lib.i18n = this.lib.i18n || BEM.I18N;</span>
        }
    }
};
&nbsp;
...
var buildEscape = (function() {
    var ts = { '"': '&amp;quot;', '&amp;': '&amp;amp;', '&lt;': '&amp;lt;', '&gt;': '&amp;gt;' },
        f = function(t) {
            return ts[t] || <span class="branch-1 cbranch-no" title="branch not covered" >t;</span>
        };
    return function(r) {
        r = new RegExp(r, 'g');
        return function(s) {
...
&nbsp;
    ...
    if ((mix = json.mix) &amp;&amp; (l = mix.length)) {
        for (i = 0; i &lt; l; i++) {
            if (!mix[i]) continue;
            res += ' ' + toBemCssClasses(mix[i], mix[i].elem ? json.block || <span class="branch-1 cbranch-no" title="branch not covered" >blockName </span>: base);
        }
    }
    return res;
};
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Aug 25 2014 10:06:55 GMT+0400 (MSK)</div>
</div>
